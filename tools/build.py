...
clean translation unit (`live-video-wallpaper.wh.cpp`) for Windhawk compilation.
...
class ModBuilder:
    def __init__(self, src_dir="src", output_file="live-video-wallpaper.wh.cpp"):
    ...
    def assemble(self):
        ...
        # 1. Metadata Blocks - Must start at line 1 for Windhawk PR validation
        output_chunks.append(self.metadata_blocks.get("WindhawkMod", "").strip())
        ...
        if headers:
            ...
            for header in headers:
                if header not in self.emitted_headers:
                    ...
                    output_chunks.append(header_body)
        ...
        output_chunks.append(main_body)
...
def main():
    ...
    parser.add_argument("--output", default="live-video-wallpaper.wh.cpp", help="Output generated single source file path.")
